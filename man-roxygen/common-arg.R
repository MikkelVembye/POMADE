...
#' @param d Contrast value. Can be one value or a vector of multiple values. Default is 0.
...
#'   of multiple values.
#' @param var_df Indicates the technique used to obtain the sampling variance
